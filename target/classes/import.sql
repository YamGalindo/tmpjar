...
-- Usuarios
INSERT INTO users (name) VALUE ('Cristian')
INSERT INTO users (name) VALUE ('Franco')
INSERT INTO users (name) VALUE ('Gabriela')
INSERT INTO users (name) VALUE ('Pamela')
INSERT INTO users (name) VALUE ('Paula')
INSERT INTO users (name) VALUE ('Yam')
...
INSERT INTO cities (city_name, country_id) VALUE ('Entre Ríos', 1)
...
-- Categorías
INSERT INTO categories (description, image, title) VALUE ('Selección de hoteles con los más estrictos estándares de calidad y diseño.', 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170', 'Hotel')
INSERT INTO categories (description, image, title) VALUE ('Selección de hostels con con la mejor ubicación y servicios.', 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80', 'Hostel')
INSERT INTO categories (description, image, title) VALUE ('Selección de los mejores departamentos, con los mejores servicios, comodidades y en las mejores ubicaciones.', 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80', 'Departamento')
INSERT INTO categories (description, image, title) VALUE ('Selección de bed and breakfast, con los mejores servicios y la mejor ubicación.', 'https://images.unsplash.com/photo-1540304453527-62f979142a17?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80', 'Bed and Breakfast')


-- ALOJAMIENTO 1
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Selvario 36 Hotel está bien situado en el distrito El Poblado de Medellín.', 'El corazón del país', 'Selvario 36 Hotel', 2, 5)
...
INSERT INTO featuresproducts (feature_id, product_id) VALUE (7, 2)


-- ALOJAMIENTO 3
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Esplendor by Wyndham Buenos Aires Tango goza de una ubicación ideal en Buenos Aires y ofrece habitaciones con aire acondicionado, WiFi gratuita, aparcamiento privado y servicio de habitaciones.', 'Lo clásico de la ciudad', 'Wyndham Tango', 4, 1)
...
-- ALOJAMIENTO 4
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Palacio Paz Hotel alberga un bar y ofrece habitaciones en Buenos Aires, a 700 metros de la basílica del Santísimo Sacramento y a 1,5 km del Obelisco de Buenos Aires.', 'La majestuosa obra de arte', 'Palacio Paz Hotel', 2, 1)
...
-- ALOJAMIENTO 5
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Departamento en Palermo Soho se encuentra en Buenos Aires, a 1,4 km de la plaza Serrano y a 2 km del parque ecológico de Buenos Aires, y ofrece alojamiento con WiFi gratuita, aire acondicionado.', 'En la cúspide de lo grande', 'Palermo Soho', 3, 1)
...
---- Puntuaciones
INSERT INTO scores (score, product_id, user_id) VALUE (2, 5, 1)
INSERT INTO scores (score, product_id, user_id) VALUE (5, 5, 2)
INSERT INTO scores (score, product_id, user_id) VALUE (4, 5, 3)
INSERT INTO scores (score, product_id, user_id) VALUE (1, 5, 4)
INSERT INTO scores (score, product_id, user_id) VALUE (2, 5, 5)
...
-- ALOJAMIENTO 6
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Recoleta Plaza Guido se encuentra en Buenos Aires, a solo 100 metros del cementerio de la Recoleta, y ofrece alojamiento con acceso a una piscina al aire libre y recepción 24 horas.', 'Ayres Recoleta Plaza', 'Ayres', 4, 1)
...
---- Características del alojamiento
INSERT INTO featuresproducts (feature_id, product_id) VALUE (2, 6)
...
-- ALOJAMIENTO 7
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Merit San Telmo ofrece alojamiento en el moderno barrio de San Telmo, una ubicación céntrica en Buenos Aires. Hay conexión Wi-Fi gratuita en todas las instalaciones.', 'Clásico y lujoso', 'Mérit San Telmo', 4, 1)
...
-- ALOJAMIENTO 8
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Byblos Palermo Soho está situado en el exclusivo barrio de Palermo Soho de Buenos Aires y ofrece alojamientos totalmente equipados. La plaza Serrano se encuentra a 400 metros.', 'Ubicado en el centro de la ciudad', 'Byblos Palermo Soho', 1, 1)
...
-- ALOJAMIENTO 9
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Dream Studios BA está situado a 1 calle de la Avenida Santa Fe y cuenta con piscina al aire libre, solárium, terraza y zona de barbacoa.', 'Para descansar con tranquilidad', 'Dream Studios BA', 3, 1)
...
-- ALOJAMIENTO 10
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('Vieja casona ambientada en un estilo moderno y conservando toda la escencia de los recuerdos, para que te sientas en tu hogar.', 'Moderna y acogedora', 'Vieja Casona', 3, 3)
...
-- ALOJAMIENTO 11
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('El Hostel más pintoresco de la ciudad, para disfrutar de los amigos y del paisaje cerca del centro de la ciudad.', 'Pintoresco y bien ubicado', 'Hostel Las Luces', 2, 4)
...
-- ALOJAMIENTO 12
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('Departamento moderno, amplio, con dos dormitorios y completamente equipado, ubicado en el centro de la ciudad.', 'Cómodo, morerno y con una excelente ubicación', 'Departamento céntrico', 3, 1)
...
-- ALOJAMIENTO 13
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('Square Hotel está ubicado en la mejor zona de la costa colombiana, a orillas del mar.', 'El corazón del país', 'Square Hotel', 1, 8)
...
-- ALOJAMIENTO 14
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('En el corazón de la costa colomiana y rodeado de la naturaleza, Estelar Bed & Breakfast es la mejor opción para un descanso asegurado.', 'Naturaleza y confort', 'Estelar Bed & Breakfast', 4, 6)
...
-- ALOJAMIENTO 15
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('Modern Apartament está ubicado en el centro de la Ciudad de Buenos Aires, cerca de los mejores lugares para conocer.', 'Cerca de todo', 'Modern Apartament', 3, 1)
...
-- ALOJAMIENTO 16
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('Hotel Palace 365 está ubicado en el centro de la ciudad de Bogotá. Cálido, lujoso y elegante.', 'En el corazón de la ciudad', 'Hotel Palace 365', 1, 1)
...
-- ALOJAMIENTO 17
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('Con una conveniente ubicación en Córdoba, Gala Hotel ofrece unas vacaciones inolvidables en las afueras, a 20 minutos del centro de la ciudad en auto.', 'Vacaciones inolvidables en la Ciudad de Córdoba', 'Gala Hotel', 1, 2)
...
-- ALOJAMIENTO 18
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('La Alondra Casa de Huéspedes es un confortable departamento en Medellín. Equipado para pasar unas excelentes vacaciones y disfrutar de la naturaleza.', 'Confortable y bien equipado', 'La Alondra Casa de Huéspedes', 3, 5)
...
INSERT INTO featuresproducts (feature_id, product_id) VALUE (5, 18)


-- ALOJAMIENTO 19
---- Alojamiento
INSERT INTO products (description, description_title, name, category_id, city_id) VALUE ('Santa Bárbara B&B está ubicada en plena Ciudad de Bogotá. Cómodo y amueblado, para unas vacaciones ideales.', 'Vacaciones en Bogotá', 'Santa Bárbara B&B', 4, 7)
